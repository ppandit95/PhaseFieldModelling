...
void TransientProblem::Output() const{
	std::ofstream write_output("/media/pushkar/Data/Personal Files/PhaseFieldModelling/Chapter4/1DTransient/Output/Initial_Profile.dat");
...
void TransientProblem::Output(unsigned int t) const{
	if(t%100 == 0){
			std::string filename ="/media/pushkar/Data/Personal Files/PhaseFieldModelling/Chapter4/1DTransient/Output/Output-"+std::to_string(t)+".dat";
